      ...
      <table className="w-full border-collapse" style={{ fontSize: '13.5px' }}>
        ...
        <tbody>
          {sortedTasks.map((task, i) => (
            <tr key={task._id} className="table-row table-row-animate" style={{ animationDelay: `${i * 0.05}s` }}>
              {/* Title + description */}
              ...
              <td className="table-td">
                <div className="flex gap-1.5">
                  <button onClick={() => onEdit(task)} title="Edit task" className="action-btn action-btn-edit">
                    <IconEdit />
                  </button>
                  <button onClick={() => handleDelete(task._id)} title="Delete task" className="action-btn action-btn-delete">
                    <IconDelete />
                  </button>
                </div>
              </td>
